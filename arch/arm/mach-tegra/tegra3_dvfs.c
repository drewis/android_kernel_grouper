...
//	CPU_DVFS("cpu_g",  4, 2, MHZ, 520, 520, 700, 700,  860,  860, 1050, 1150, 1200, 1280, 1300, 1340, 1380, 1500, 1600),
	CPU_DVFS("cpu_g",  4, 2, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600),

	/*Cpu voltages (mV):	      775, 775, 825, 825,  900,  900,  975,  975, 1000, 1000, 1025, 1050, 1100, 1125, 1175, 1200, 1212, 1237 */
//	CPU_DVFS("cpu_g",  4, 2, MHZ, 475, 475, 620, 620,  860,  860, 1000, 1000, 1100, 1100, 1200, 1300, 1400, 1500, 1600),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 294000, 342000, 475000, 550000,  550000,  550000,  550000,  550000),
#endif
	...
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 342000, 475000, 550000, 666000,  666000,  666000,  666000,  666000),
#endif
